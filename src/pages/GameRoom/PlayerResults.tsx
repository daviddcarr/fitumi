...
export default function PlayerResults() {
    ...
    return (
        <div className="flex flex-col min-h-screen items-center justify-center p-8 bg-purple-950">
            <h2 className="text-4xl tracking-wider font-bold mb-4 text-white font-heading">{outcomeMsg}</h2>

             {/* 1) Vote tally (sorted): */}
            <div className="mb-6 w-full max-w-md">
                <h3 className="text-2xl font-semibold font-heading text-white mb-2">Vote Tally</h3>
                ...
                {ranked.map((pid) => {
                    ...
                    >
                        ...
                        <span className="text-purple-400">{count} vote{count !== 1 ? "s" : ""}</span>
                    </li>
                    );
                })}
                </ul>
            ...
            <div className="mb-6 w-full max-w-md">
                <h3 className="text-2xl font-semibold font-heading text-white mb-2">Overall Scores</h3>
                <ul className="divide-y divide-gray-200">
                {players.map((p) => {
