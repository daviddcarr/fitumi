...
export default function GameRoom() {
        ...
        const channel = supabase
            ...
            .on(
                ...
                (payload) => {
                    ...
                    setPlayers((current) => current.filter((p) => p.id !== (payload.old as Player).id))
                }
            )
            .subscribe()
    ...
    useEffect(() => {
        ...
        const sorted = [...players].sort((a, b) => new Date(a.created_at).getTime() - new Date(b.created_at).getTime())
